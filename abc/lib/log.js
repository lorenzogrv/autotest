 ...
 */
function Log( from ){
  from = callsite( 'function' == typeof from? from : Log );
  ...
  return Log.cache[ instance.filename ] = instance;
}
...
exports.fatal = function( code ){
  ...
  this.err( hasCode? [].slice.call(arguments, 1) : arguments, {
    color: 'red', prepend: 'FATAL: ', level: exports.FATAL
  });
  process.exit( hasCode? code : 1 );
};
exports.error = function( ){
  return this.err( arguments, {
    color: 'red', prepend: 'ERROR: ', level: exports.ERROR
  });
};
exports.warn = function( ){
  return this.err( arguments, {
    color: 'yellow', prepend: 'WARN: ', level: exports.WARN
  });
};
exports.info = function( ){
  return this.out( arguments, {
    color: 'blue', prepend: '', level: exports.INFO
  });
};
exports.verb = exports.debug = function( ){
  return this.out( arguments, { prepend: 'DEBUG: ', level: exports.VERB });
};
